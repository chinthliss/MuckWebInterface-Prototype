        ...
        if (!isset($this->categoryConfiguration)) {
            ...
            $this->categoryConfiguration = [
                ...
                new SupportTicketCategory('character', 'Character', 'issue',
                    'Character issues, such as skills, abilities, or statuses.'),
                ...
                new SupportTicketCategory('gear', 'Gear', 'issue',
                    'Pieces of equipment missing, broken, or accidentally deleted.'),
                new SupportTicketCategory('theme', 'Theme / Typo', 'issue',
                    'Mistakes or inconsistencies on rooms, npcs, encounters, or items in the game. This includes spelling or grammatical errors.'),
                new SupportTicketCategory('web', 'Website', 'issue',
                    'Problems with the website.'),
                // Requests
                new SupportTicketCategory('building', 'Building', 'request',
                    'For submitting building contracts, such as Land Deeds and Private Hunting grounds.'),
